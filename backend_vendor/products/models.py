...
class Category(models.Model):
    ICON_CHOICES = [
        ...
        ('fa-tshirt', 'Fashion & Clothing'),
        ('fa-home', 'Home & Garden'),
        ('fa-futbol', 'Sports & Outdoors'),
        ('fa-spa', 'Beauty & Personal Care'),
        ('fa-book', 'Books & Media'),
        ('fa-gamepad', 'Toys & Games'),
        ('fa-shopping-basket', 'Food & Grocery'),
        ('fa-heartbeat', 'Health & Wellness'),
        ('fa-gem', 'Jewelry & Watches'),
        ('fa-car', 'Automotive'),
        ('fa-baby', 'Baby & Kids'),
        ('fa-paw', 'Pet Supplies'),
    ...
    icon = models.CharField(max_length=50, choices=ICON_CHOICES, default='fa-shopping-basket')
    description = models.TextField(blank=True)  # Kept for backward compatibility
    image = models.ImageField(upload_to='categories/', blank=True, null=True)  # Kept for backward compatibility
...
class Product(models.Model):
    ...
    vendor = models.ForeignKey(
        ...
        null=True,  # Nullable for backward compatibility with existing products
        blank=True,
    ...
    # Analytics - Track product views/clicks for featured products sorting
